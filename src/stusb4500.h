...
typedef void (*stusb4500_delay_ms_func_t)(uint32_t);
typedef uint32_t (*stusb4500_get_ms_func_t)(void);

typedef struct {
    stusb4500_current_t min_current_ma; // 25mA increments
    stusb4500_voltage_t min_voltage_mv; // 50mV increments
    stusb4500_voltage_t max_voltage_mv; // 50mV increments
    stusb4500_get_ms_func_t get_ms;
    stusb4500_delay_ms_func_t delay_ms;
} stusb4500_config_t;
