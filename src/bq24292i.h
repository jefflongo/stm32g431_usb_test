...
__attribute__((nonnull)) bool bq24292i_get_charge_current(bq24292i_prechg_current_t* ma);
...
__attribute__((nonnull)) bool bq24292i_set_recharge_offset(bq24292i_vrechg_offset_t* offset);
